						...
						<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" class="mtableborder">
																...
																<tr>
																	<td background="images/lbg.jpg" valign="top" align="left">
																		...
																		<div style="position:absolute;left:400px;top:15px;width:150px;height:40px;" class="icon">
																			...
																			<a href="http://www.odnoklassniki.ru/spravka1560">
																				<span class="icon odnoklassniki"></span>
																			</a>
																			<a href="http://www.facebook.com/spravka1560">
																				<span class="icon facebook"></span>
																			</a>
																			<a href="https://twitter.com/spravka1560">
							...
							<tr>
								<td>
									...
									<!-- <marquee scrollamount="1" scrolldelay="20" align="middle" direction="left" height="130"> <xsl:for-each select="//content/baners/item[id_section=468]"> <xsl:value-of select="url" disable-output-escaping="yes"/> 
											...
											<td>
												<div style="padding:10px">
													...
													<div class="text3">
														...
														<br />
														<a href="http://oksamitnyj.pp.ua" style="color:#FFF;decoration:underline;">Создание сайта - WebKontora</a>
													</div>
												</div>
											</td>
